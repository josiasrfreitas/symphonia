...
Findings carry the structured codes defined in `.symphonia/src/adapters/attention.py` — the substring matching of the prototype is replaced by declared codes (reopens the GRE-153 note on structured Attention).
