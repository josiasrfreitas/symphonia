"""Tests for `journal` — the event journal and delivery receipt
persisted by `spawn.wait`. Run either way:

    cd .symphonia/src && python3 -m unittest tests.test_journal
    python3 .symphonia/src/tests/test_journal.py
"""
