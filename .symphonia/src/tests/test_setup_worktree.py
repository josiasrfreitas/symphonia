...
a fake would be testing the mock. Run either way:
    ...
    cd .symphonia/src && python3 -m unittest tests.test_setup_worktree
    python3 .symphonia/src/tests/test_setup_worktree.py
"""
...
PACKAGE = Path(__file__).resolve().parents[1]  # .symphonia/src, the sys.path root since the move
