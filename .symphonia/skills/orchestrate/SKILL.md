---
name: orchestrate
description: Single entry point of the Symphonia workflow. Use when asked to run, resume, or advance delivery on this project.
---
...
2. `.symphonia/reconcile/README.md` — every run starts with Reconciliation.
